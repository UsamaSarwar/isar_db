...
class IsarCoreBindings {
  ...
  late final _isar_filter_string_regexPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<CFilter> Function(
            ffi.Uint16,
  ...
  late final _isar_filter_inPtr =
      _lookup<
        ...
        >
      >('isar_filter_in');
  late final _isar_filter_in = _isar_filter_inPtr
      .asFunction<
        ffi.Pointer<CFilter> Function(
          int,
          ffi.Pointer<COption_IsarValue>,
  ...
  late final _isar_change_encryption_keyPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Uint8 Function(ffi.Pointer<CIsarInstance>, ffi.Pointer<CString>)
        >
      >('isar_change_encryption_key');
  late final _isar_change_encryption_key = _isar_change_encryption_keyPtr
      .asFunction<
  ...
  late final _isar_values_newPtr =
      _lookup<
  ...
  late final _isar_values_set_boolPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<COption_IsarValue>,
  ...
  late final _isar_values_set_integerPtr =
      _lookup<
        ffi.NativeFunction<
  ...
  late final _isar_values_set_realPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<COption_IsarValue>,
  ...
  late final _isar_values_set_stringPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<COption_IsarValue>,
  ...
  late final _isar_values_set_string = _isar_values_set_stringPtr
      .asFunction<
  ...
  late final _isar_values_freePtr =
      _lookup<
        ffi.NativeFunction<
