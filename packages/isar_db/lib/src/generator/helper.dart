// ignore_for_file: deprecated_member_use, lines_longer_than_80_chars - Allow deprecated members during Element2 migration
      ...
      if (collectionAnnotation?.inheritance ?? embeddedAnnotation!.inheritance)
        for (final supertype in allSupertypes) ...{
          if (!supertype.isDartCoreObject)
            for (final accessor in supertype.accessors) accessor.variable2!.name: accessor.variable2!,
        },
      for (final accessor in accessors) accessor.variable2!.name: accessor.variable2!,
    };
